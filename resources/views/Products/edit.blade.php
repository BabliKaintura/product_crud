...
<div class="col-12 text-center pt-5">
			<h1 class="display-one mt-5">Edit Product</h1>
			<div class="text-left"><a href="{{route('products.index')}}" class="btn btn-outline-primary">Product List</a></div>
				...
				<div class="control-group col-6 mt-2 text-left">
					...
					<div>
						<textarea id="short_notes" class="form-control mb-4" name="short_notes"
							placeholder="Enter Short Notes" rows="" value="{{ $product->short_notes }}"required></textarea>
					</div>
				</div>
